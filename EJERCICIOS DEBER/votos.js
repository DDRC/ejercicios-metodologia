var votos = ["Daniel", "Adrian", "Patricia", "Daniel", "Patricia", "Tatiana"];
...
/*for (let j = 0; j < votos.length - 1; j++) {
    if (votos[j] == null || votos[j] == undefined || votos[j] == Symbol || votos[j] == Number) {
        alert("Algun elemento de las votaciones no es valido");
    }
}*/
