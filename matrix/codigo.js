...
/*
console.log(tablas.rows[vertical].cells[horizontal].innerHTML);
                        console.log("filas"+maxrows);
                            console.log("columnas"+maxcols);
switch (operacion) {
                            case 1:
                                resultado=tablas.rows[vertical].cells[horizontal].innerHTML+tablas.rows[vertical].cells[horizontal].innerHTML;
                                break;
                                case 2:
                                resultado=tablas.rows[vertical].cells[horizontal].innerHTML-tablas.rows[vertical].cells[horizontal].innerHTML;
                                break;
